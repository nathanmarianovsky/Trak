	...
	splashWindow.webContents.on("did-finish-load", () => {
		...
		fs.mkdir(assetsDir, { "recursive": true }, assetsDirErr => {
			...
			if(assetsDirErr) {
				...
				throw Error("The application cannot load properly without the existence of configuration folders.");
			}
			...
			fs.mkdir(dataDir, { "recursive": true }, dataDirErr => {
				...
				if(dataDirErr) {
					...
					throw Error("The application cannot load properly without the existence of a library data folder.");
				}
				...
				fs.mkdir(localPagesDir, { "recursive": true }, localPagesDirErr => {
					...
					if(localPagesDirErr) {
						...
						throw Error("The application cannot load properly without the existence of a localPages folder.");
					}
					...
					fs.mkdir(localStylesDir, { "recursive": true }, localStylesDirErr => {
						...
						if(localStylesDirErr) {
							...
							throw Error("The application cannot load properly without the existence of a localStyles folder.");
						}
						...
						fs.readFile(path.join(basePath, "Trak", "config", "configuration.json"), "UTF8", (err, file) => {
							...
							if(err) {
								...
								throw Error("The application cannot continue loading without reading the configuration file.")
							}
						    ...
						    fs.copyFile(path.join(__dirname, "assets", (darkCondition ? "white" : "black") + "Logo.png"), path.join(basePath, "Trak", "config", "assets", "logo.png"), assetsCopyErr => {
								...
								if(assetsCopyErr) {
									...
									throw Error("The application cannot continue without having a proper icon.");
								}
							    ...
							    fs.readFile(path.join(__dirname, "pages", "dist", "index.html"), "UTF8", (issue, indexPage) => {
							    	...
							    	if(issue) {
							    		...
							    		throw Error("An issue came up when reading the home page html file preventing the application from loading.");
							    	}
									...
									fs.writeFile(path.join(basePath, "Trak", "localPages", "index.html"), indexPage, "UTF8", prob => {
										...
										if(prob) {
											...
											throw Error("The home page html could not be properly modified. As such the application cannot load properly.");
										}
										...
										fs.readFile(path.join(__dirname, "pages", "dist", "addRecord.html"), "UTF8", (iss, addRecordPage) => {
											...
											if(iss) {
												...
												throw Error("An issue came up when reading the secondary html file preventing the application from loading.");
											}
											...
											fs.writeFile(path.join(basePath, "Trak", "localPages", "addRecord.html"), addRecordPage, "UTF8", problem => {
												...
												if(problem) {
													...
													throw Error("The secondary html page could not be properly modified. As such the application cannot load properly.");
												}
												...
												fs.readFile(path.join(__dirname, "styles", "dist", "styles.css"), "UTF8", (readErr, stylesFile) => {
													...
													if(readErr) {
														...
														throw Error("An issue came up when reading the primary css file preventing the application from loading.");
													}
													...
													fs.writeFile(path.join(basePath, "Trak", "localStyles", "styles.css"), stylesFile, "UTF8", writeErr => {
														...
														if(writeErr) {
															...
															throw Error("The primary css file could not be properly modified. As such the application cannot load properly.");
														}
