    ...
    ipcRenderer.on("sentAllRecords", (recordsEvent, recordsArr) => {
        ...
        ipcRenderer.on("sentNotifications", (notificationsEvent, notificationsFileStr) => {
            ...
            // Otherwise proceed as normal.
                ...
                // console.log(lightOrDark("rgba(0,0,0,0.87)"));
                // console.log(visibleElementsWithText);
                // // console.log(visibleElementsWithText[0]);
                // // console.log(visibleElementsWithText[0].style.color);
                // console.log(elementData);
                // // console.log(elementData[0].element);
                // // console.log(document.querySelector(elementData[0].path));
                // // console.log(elementData[0].element.getAttribute("background-color"));
                // // visibleElementsWithText.forEach(elem => elem.style.color = (isDark(elem.style.backgroundColor) ? "white" : "black"));
                // Array.from(document.querySelectorAll(".recordsRowDiv")).forEach(elem => {
                //     // elem.style.color = (isDark(getComputedStyle(elem).backgroundColor) ? "white" : "black")
                //     console.log(getComputedStyle(elem).backgroundColor);
                //     console.log(isDark(getComputedStyle(elem).backgroundColor));
                //     console.log(isDark(elem.style.backgroundColor));
                // });
